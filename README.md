...
[![Deploy to PandaStack](https://dashboard.pandastack.io/deploy-button.svg)](https://dashboard.pandastack.io/deploy?repo=steven-tey/precedent&type=static&buildCmd=npm+run+build&outputDir=dist)
